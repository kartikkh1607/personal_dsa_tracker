...
export default function Credit({ className = '' }) {
  return (
    <footer className={`flex flex-col items-center px-4 pb-4 pt-12 text-center ${className}`}>
      ...
      <p className="mt-3 text-[11px] font-medium uppercase tracking-[0.22em] text-muted">Made with care by</p>
      <p className="mt-0.5 font-script text-[1.75rem] leading-tight text-accent sm:text-3xl">Kartik Khandelwal</p>
    </footer>
  )
}
